...
In order to run the code, one can clone the repo and then use the .Rmd file. Trivial data simulation is provided below instead of real user data (GDPR compliance).
